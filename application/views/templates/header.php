...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>plugins/table/datatable/custom_dt_multiple_tables.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>plugins/jquery-step/jquery.steps.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>plugins/select2/select2.min.css">
	<link href="<?php echo base_url() ?>assets/css/elements/infobox.css" rel="stylesheet" type="text/css" />
	<link rel="stylesheet" href="<?php echo base_url() ?>plugins/editors/markdown/simplemde.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/forms/theme-checkbox-radio.css">
	<link href="<?php echo base_url() ?>plugins/notification/snackbar/snackbar.min.css" rel="stylesheet" type="text/css" />
